...
## Додаткові ролі для лабораторної 6:  
**Test Lead**: Правило Анастасія -	Координує модульне тестування та вимірювання покриття.  
**Debugger** Демʼянік Катерина - Керує челенджем налагодження та документує знахідки.  
**QA Planner** Сич Анастасія -	Пише документ стратегії тестування та інтегрує тестування в CI.  
**Integration Lead**: Титаренко Владислава - Забезпечує інтеграцію тестів у проєкт та CI pipeline

## Додаткові ролі для лабораторної 7:  
**Test Planner**: Демʼянік Катерина -	Координує складання тест-плану та структуру таблиці   
**Review Manager**: Титаренко Владислава -	Збирає/передає плани між командами, фіксує фідбек   
**QA Analyst**: Сич Анастасія -	Узагальнює результати перевірки іншої команди   
**Documentation Lead**: Правило Анастасія -	Оновлює test-plan.md і створює review-log.md   

## Додаткові ролі для лабораторної 8:  
**Code Analyst**: Сич Анастасія -	Виконує аналіз у SonarCloud, фіксує початкові метрики
**Refactoring Lead**: Демʼянік Катерина -	Координує внесення змін і перевіряє якість коду
**QA Engineer**: Титаренко Владислава -	Запускає тести, фіксує результати регресії
**Release Manager**: Правило Анастасія -	Оновлює CHANGELOG і семантичну версію

## Додаткові ролі для лабораторної 9:  
**Reliability Explorer**: Демʼянік Катерина - Веде пошук і збір первинних проблем
**Fault Classifier**: Сич Анастасія - Класифікує fault/error/failure + severity
**Resilience Engineer**: Титаренко Владислава - Пише виправлення та покращення
**Risk Documentarian**: Правило Анастасія - Підтримує звіти та готує презентацію

## Додаткові ролі для лабораторної 10:
**Data Gatherer (Аналітик даних CI/CD)**: Демʼянік Катерина - Збирає статистику з CI/CD історії (успішні/невдалі збірки, час виконання).
**Metrics Analyst (Аналітик DORA)**: Сич Анастасія - Розраховує показники DORA, будує таблиці та графіки.
**Improvement Designer (Розробник покращень)**: Титаренко Владислава - Аналізує причини збоїв і формує пропозиції щодо оптимізації процесу.
**Documentation Lead (Репортер)**: Правило Анастасія - Упорядковує /docs/ci-cd/dora-summary.md, готує слайд або відео-презентацію.
